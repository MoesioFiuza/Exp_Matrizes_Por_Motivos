...
# Print contagem_viagens before applying fator_expansao
print("Contagem de viagens antes do fator de expansão:")
print(contagem_viagens)

contagem_viagens['count'] *= contagem_viagens.apply(get_fator_expansao, axis=1)

# Print contagem_viagens after applying fator_expansao
print("Contagem de viagens após aplicar o fator de expansão:")
print(contagem_viagens)
